...
```{r}
#setting seed for repeat-ability
set.seed(000027)

#adding ties
net2 <- igraph::add_edges(net, c(1,8, 2,9, 3,12, 7,12))
#deleting ties
net2 <- delete_edges(net2, c(1,10, 3,4, 10,11))

#adding nodes
net2 <- igraph::add_vertices(net2, c(nv = 4))
#deleting nodes
net2 <- delete_vertices(net2, c(12, 5, 4))
#renaming the nodes
V(net2)$name <- as.character(1:vcount(net2))

#rewiring
net2<- igraph::rewire(net2, each_edge(p = .5, loops = F))
```
<br>
