...
nodes <- read.csv('/Users/TomTheIntern/Desktop/Mendoza/Mod 4/Networks/Homework/msbr_70340_SP25_sociocentric_nodelist.csv')
summary(nodes)
edges <- read.csv('/Users/TomTheIntern/Desktop/Mendoza/Mod 4/Networks/Homework/msbr_70340_SP25_sociocentric_edgelist.csv')
summary(edges)
...
```{r}
round(max(betweenness(net_sna)), 2)
```
```{r}
max(degree(net))
```
